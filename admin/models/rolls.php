 ...
 * Years Model
 */
class PotterModelRolls extends JModelLegacy
{
...
//	    global $mainframe, $context;
	    ...
	    $orders = array('published','ma_name', 'haus', 'Magie', 'sex','id'); 
		...
		$plus = '';
		if ($filter_order != 'ma_name')
		{
			$plus = ', ma_name,ma_vname'; 
		}
...
//	    global $mainframe, $context; 
	    ...
	    if ($search = trim($search))
    	{
        	...
        	$where[] = '(LOWER(ma_name) LIKE "%'.$search.'%" OR '.
					   'LOWER(ma_vname) LIKE "%'.$search.'%")'	;
	    }
