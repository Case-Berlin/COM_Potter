 ...
 * Years Model
 */
class PotterModelArtists extends JModelLegacy
{
...
//				 ' ORDER BY published desc, fezma, realname,realvname';
		return $query;
	}
...
//	    global $mainframe, $context;
	    ...
	    $orders = array('published','realname', 'Telefon', 'email', 'fezma', 'joomlaid', 'id'); 
		...
		$plus = '';
		if ($filter_order != 'realname')
		{
			$plus = ', realname,realvname'; 
		}
...
//	    global $mainframe, $context; 
	    ...
	    if ($search = trim($search))
    	{
        	...
        	$where[] = '(LOWER(realname) LIKE "%'.$search.'%" OR '.
					   'LOWER(realvname) LIKE "%'.$search.'%")'	;
	    }
